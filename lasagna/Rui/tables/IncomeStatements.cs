        ...
        public IncomeStatements(GenericDAO genericDaoOut)
    {
        ...
        public int insertIncomeStatements(String IncomeStatements, int index)
        {
            ...
            var income = new IncomeStatement
            {
                ...
                Development = System.Convert.ToDecimal(item["ev_ebitda"][index].ToString()),
                OtherOperatingExpense = System.Convert.ToDecimal(item["ev_ebit"].ToString()),
                // = System.Convert.ToDecimal(item["ev_pretax_inc"].ToString()),
