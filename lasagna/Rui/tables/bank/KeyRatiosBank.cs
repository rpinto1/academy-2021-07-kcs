        ...
        public Task<KeyRatio> InsertKeyRatios(String keyRatios, int index)
        {
            ...
            //        Console.WriteLine(item["payout_ratio"]);
                    ...
                    var KeyRatioObject =  new KeyRatio
                    {
                        ...
                        EarningAssetsToEquity = Decimal.Parse(item["earning_assets_to_equity"][index].ToString(), System.Globalization.NumberStyles.Float),
                        ...
                        NetInterestIncomeGrowthBank = Decimal.Parse(item["net_interest_income_growth"][index].ToString(), System.Globalization.NumberStyles.Float),
                        ...
                        CashFromOperationsGrowth = Decimal.Parse(item["cash_and_equiv_growth"][index].ToString(), System.Globalization.NumberStyles.Float),
                        GrossLoansGrowth = Decimal.Parse(item["loans_gross_growth"][index].ToString(), System.Globalization.NumberStyles.Float),
                        EarningAssetsGrowth = Decimal.Parse(item["earning_assets_growth"][index].ToString(), System.Globalization.NumberStyles.Float),
                        ...
                        TotalDepositGrowth = Decimal.Parse(item["deposits_growth"][index].ToString(), System.Globalization.NumberStyles.Float),
