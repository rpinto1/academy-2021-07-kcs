    ...
    class BalanceSheetsBank
    {
        ...
        public Task<BalanceSheet> insertBalanceSheets(String balanceSheets, int index)
        {
            ...
            var balance = new BalanceSheet
            {
                ...
                TotalInvestments = Decimal.Parse(item["total_investments"][index].ToString(), System.Globalization.NumberStyles.Float),
                GrossLoans = Decimal.Parse(item["loans_gross"][index].ToString(), System.Globalization.NumberStyles.Float),
                AllowanceLoanLosses = Decimal.Parse(item["allowance_for_loan_losses"][index].ToString(), System.Globalization.NumberStyles.Float),
                UnearnedIncome = Decimal.Parse(item["unearned_income"][index].ToString(), System.Globalization.NumberStyles.Float),
                NetLoans = Decimal.Parse(item["loans_net"][index].ToString(), System.Globalization.NumberStyles.Float),
                ...
                DepositsLiability = Decimal.Parse(item["deposits_liability"][index].ToString(), System.Globalization.NumberStyles.Float),
