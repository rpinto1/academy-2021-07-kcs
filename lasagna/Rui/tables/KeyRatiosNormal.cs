    ...
    class KeyRatiosNormal
    {
        ...
        public Task<KeyRatio> InsertKeyRatios(String keyRatios, int index)
        {
            ...
            var KeyRatioObject =  new KeyRatio
                ...
                ReturnOnTangibleCapitalEmployed = Decimal.Parse(item["rotce"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                GrossMargin = Decimal.Parse(item["gross_margin"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                ...
                FreeCashMargin = Decimal.Parse(item["fcf_margin"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                ...
                DebtToAssets = Decimal.Parse(item["debt_to_assets"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                RevenueGrowth = Decimal.Parse(item["revenue_growth"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                GrossProfitGrowth = Decimal.Parse(item["gross_profit_growth"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                ...
                Ppegrowth = Decimal.Parse(item["ppe_growth"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                ...
                CashFromOperationsGrowth = Decimal.Parse(item["cfo_growth"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                CapitalExpendituresGrowth = Decimal.Parse(item["capex_growth"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                FreeCashFlowGrowth = Decimal.Parse(item["fcf_growth"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                FreeCashFlow = Decimal.Parse(item["fcf"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                BookValue = Decimal.Parse(item["book_value"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                TangibleBookValue = Decimal.Parse(item["tangible_book_value"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
                ...
                FreeCashFlowPerShare = Decimal.Parse(item["fcf_per_share"]?[index].ToString() ?? "0", System.Globalization.NumberStyles.Float),
